    ...
    <nav className="relative">
      ...
      <ul className="hidden md:flex items-center gap-8 text-slate-800 font-medium">
        ...
        <li className="relative group">
          ...
          <div className="absolute left-0 top-full mt-2 bg-white shadow-lg rounded-md p-4 w-56 opacity-0 invisible scale-95 group-hover:opacity-100 group-hover:visible group-hover:scale-100 transition-all duration-200 origin-top">
            <ul className="space-y-2 text-sm">
      ...
      {/* ================= MOBILE DRAWER ================= */}
      <div className={`fixed top-0 right-0 h-full w-64 bg-white shadow-xl z-50 transform transition-all duration-300 ease-in-out ${
        ...
        <div className="flex flex-col space-y-6 px-6 text-slate-800 font-medium">
          ...
          <div>
            ...
            {mobileMaterialsOpen && (
              <div className="ml-4 mt-2 space-y-2 text-sm flex flex-col transition-all duration-300">
      ...
      {mobileOpen && (
        <div className="fixed inset-0 bg-black/40 z-40 transition-opacity duration-300" onClick={() => setMobileOpen(false)} />
      )}
